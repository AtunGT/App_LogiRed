...
class RegisterDriverRepositoryImpl implements RegisterDriverRepository {
  ...
  Future<void> register(DriverData data) async {
    final map = <String, dynamic>{
      ...
      'backview_image': await MultipartFile.fromFile(data.imgVehicleBack,
          filename: 'vehicle_back.jpg'),
      'leftview_image': await MultipartFile.fromFile(data.imgVehicleLeft,
          filename: 'vehicle_left.jpg'),
      'rightview_image': await MultipartFile.fromFile(data.imgVehicleRight,
          filename: 'vehicle_right.jpg'),
